...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalAttendeeIgnored() {
    // Have each required person have different events. We should see two options because each required person has
    // split the restricted times.
    // Optional attendee C has an all-day event. The same three time slots should be returned as when C was not
    // invited.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------| 
  ...
  @Test
  public void optionalAttendeesOnlyWithScheduleGaps() {
  ...
  @Test
  public void optionalAttendeesOnlyWithNoScheduleGaps() {
    // Have each optional person have different events. We should see two options because each optional person has
    // split the restricted times.
    //
    // Events  : |---------A--|
